...
import { Typography, Button, Stepper, Step, StepLabel, Container } from "@material-ui/core"
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="textSecondary" component="p">
           Basic Plan of our Tour you can benefits a lot of our Museum Guides is simply dummy text of the printing and typesetting industry.
...
const Subscription = () => {
    ...
    return (
        <div>
            ...
            <form>
                <GetStepContent activeStep={activeStep} handleNext={handleNext} handleBack={handleBack} />
            </form>
            {
                activeStep === 4 ? (
                    <Typography variant="h3" align="center" >Thanks for Subscribing</Typography>
                ) : (<>
